...
respuestas_usuario = {
    ...
    'independencia' : 5,
    'coordinacion' : 4,
    'creatividad_habilidad' : 2,
    'tecnologia_habilidad' : 5,
    'resolucion_problemas' : 4,
    'expresion_artistica' : 3,
    'trabajo_equipo' : 4,
    'debates' : 1,
    'actividades_grupales' : 1,
    'colaboracion' : 2,
    'compartir_ideas' : 3,
    'competir' : 5,
    'aprendizaje' : 4,
    #'ayudar' : 0,
    'autoexpresion_valor' : 3,
    'superar_limites' : 5,
    #'relajacion' : 0,
    'liberar_energia' : 5,
    'desconectar' : 4,
    'creatividad_relajacion' : 1,
    'deportes_relajacion' : 5,
    'mejorar_habilidades' : 4,
    'desarrollo_liderazgo' : 3,
    'equilibrio_salud' : 4,
    'aprender_nueva_habilidad' : 4,
    'crecimiento_personal' : 3
}
